...
int main(int argc, char* argv[]) {
    ...
    cout << "Welcome to fileSim! Type `help` to view commands. What size disk would you wish to simulate?" << endl;
    cin >> diskSize;

    bool quit = false;

    // Initialize an object of the FileSim class
    FileSim fs = FileSim(diskSize); // TODO: how do we want to set this?
